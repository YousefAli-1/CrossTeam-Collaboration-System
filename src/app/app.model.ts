...
export type Task={readonly taskId: number, taskName: String, description: String, deadline: Date, assigned: Team, isSubmitted: boolean, submittedBy: TeamMember | null, approvalWorkflow: ApprovalRequest[], project: Project,projectName?:String, createdAt: Date, updatedAt: Date};
